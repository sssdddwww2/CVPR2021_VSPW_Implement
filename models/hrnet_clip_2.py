...
class HRNetV2_clip2(nn.Module):
    def __init__(self, n_class,args, **kwargs):
        super(HRNetV2_clip2, self).__init__()
        self.hrnetv2 = HRNetV2(n_class=n_class, **kwargs)
        self.args = args
                
         
    def forward(self,c_img,clip_imgs,is_train=False):
        
        


def hrnetv2_clip2(pretrained=False, **kwargs):
    model = HRNetV2_clip2(n_class=1000, **kwargs)
#    if pretrained:
